...
const QUESTION_BANK = {
  common: [
    ["언제 있었던 일이야?", "어디에서 있었던 일이야?", "그때 누가 함께 있었어?", "가장 기억에 남는 장면은 어떤 모습이야?"],
  ...
  news: [
    ...
    ["그 기사를 읽고 어떤 마음이 들었어?", "특히 어떤 문장이 걸렸어?"],
  ...
  career: [
    ...
    ["그중에서 특히 어떤 부분이 재미있어?", "그 재미의 뒤에 네가 중요하게 여기는 게 있다면 뭘까?"],
  ...
  attraction: [
    ...
    ["그걸 좋아한다는 게 너에 대해 무엇을 보여줄까?", "주변에 같은 걸 좋아하는 사람이 있어?"],
